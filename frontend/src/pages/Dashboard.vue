...
export default {
  ...
  setup() {
    ...
    return { newUser, isUserModalOpen, message, messageType, handleCreateUser, handleDeleteUser, isProtectedUser, totalOrders, totalRevenue, activeUsers, pendingDeliveries, recentOrders, users }
  }
}
</script>
